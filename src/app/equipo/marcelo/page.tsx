        ...
        <div className="max-w-6xl mx-auto relative z-10 w-full grid md:grid-cols-[1fr_1.5fr] gap-16 items-start">
          ...
          <div className="flex flex-col justify-center h-full pt-12 md:pt-0">
            ...
            <div className="mt-12 opacity-0 flex flex-wrap gap-4" ref={addToRefs}>
              <a 
                href="https://linkedin.com/in/marcelo-bilbao-534b03238/en/" 
                target="_blank" 
                rel="noreferrer" 
                className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-cyan-400 text-black shadow-[0_0_20px_rgba(0,242,255,0.3)] hover:shadow-[0_0_40px_rgba(0,242,255,0.6)] hover:-translate-y-1 transition-all duration-300 group"
                title="LinkedIn"
              >
              ...
              <a 
                href="https://github.com/Mar-Ed" 
                target="_blank" 
                rel="noreferrer" 
                className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-white/10 text-white border border-white/10 hover:bg-white/20 hover:border-white/30 shadow-xl hover:-translate-y-1 transition-all duration-300 group"
                title="GitHub"
              >
